            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-8">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[10px] font-black text-brand uppercase tracking-widest">深度神经网络训练中</span>
                    </div>
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">AI 文案实验室</h1>
                    <p className="text-slate-500 font-medium text-xs mt-1 opacity-60">Neural Copywriting Hub & Strategic Content Factory</p>
                </div>
            </div>
